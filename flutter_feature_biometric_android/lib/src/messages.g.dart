...
class FlutterFeatureBiometricApi {
  ...
  Future<bool> isDeviceSupported() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.flutter_feature_biometric_android.FlutterFeatureBiometricApi.isDeviceSupported$pigeonVar_messageChannelSuffix';
