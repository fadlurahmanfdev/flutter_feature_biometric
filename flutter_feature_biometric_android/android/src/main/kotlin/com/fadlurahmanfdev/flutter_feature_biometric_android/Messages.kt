...
interface FlutterFeatureBiometricApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: FlutterFeatureBiometricApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.flutter_feature_biometric_android.FlutterFeatureBiometricApi.isDeviceSupported$separatedMessageChannelSuffix", codec)
        if (api != null) {
