...
enum IOSLAPolicy: Int, CaseIterable {
  case biometric = 0
  case deviceCredential = 1
}

enum IOSAuthenticationResultStatus: Int, CaseIterable {
  case success = 0
...
struct IOSAuthenticationResult: Hashable, CustomStringConvertible {
  ...
  static func == (lhs: IOSAuthenticationResult, rhs: IOSAuthenticationResult) -> Bool {
    ...
    return MessagesPigeonInternal.deepEquals(lhs.status, rhs.status) && MessagesPigeonInternal.deepEquals(lhs.encodedDomainState, rhs.encodedDomainState)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("IOSAuthenticationResult")
    MessagesPigeonInternal.deepHash(value: status, hasher: &hasher)
    MessagesPigeonInternal.deepHash(value: encodedDomainState, hasher: &hasher)
  }

  public var description: String {
    return "IOSAuthenticationResult(status: \(String(describing: status)), encodedDomainState: \(String(describing: encodedDomainState)))"
  }
}
